...
public class HttpRequest_GetPathTest {
    ...
    public void getPath_PostRequestNormal_Path() {
        ...
        assertThat(path).isEqualTo("api/getDataFromPM");
    }
    ...
    public void getPath_PostRequestLongMethodName() {
        ...
        assertThat(path).isEqualTo("api/abcdefghijklmonpqrstuvxyz_abcdefghijklmonpqrstuvxyz_abcdefghijklmonpqrstuvxyz_abcdefghijklmonpqrstuvxyz_abcdefghijklmonpqrstuvxyz_abcdefghijklmonpqrstuvxyz");
    }
    ...
    public void getPath_PostRequestShortMethodName() {
        ...
        assertThat(path).isEqualTo("api/a");
    }
}
