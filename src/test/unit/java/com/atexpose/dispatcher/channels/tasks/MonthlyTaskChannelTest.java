...
public class MonthlyTaskChannelTest {
    ...
    public void constructor_DayOfMonthTooLow_Exception() {
        assertThatExceptionOfType(RuntimeException.class)
                .isThrownBy(() ->
                        new MonthlyTaskChannel("theTaskName", "request", "23:55", 0, "UTC"))
    ...
    public void constructor_DayOfMonthTooHigh_Exception() {
        assertThatExceptionOfType(RuntimeException.class)
                .isThrownBy(() -> new MonthlyTaskChannel("theTaskName", "request", "23:55", 29, "UTC"))
    ...
    public void getState_TaskTimeContainsTimeOfDayAndDayOfMonth() {
        MonthlyTaskChannel stc = new MonthlyTaskChannel("TaskName3", "TheRequest3", "23:53", 28, "UTC");
    ...
    public void getTimeToFireNext_Now1HourBeforeTaskTime_SameDayAtTaskTime() {
        ...
        MonthlyTaskChannel dailyTaskChannel = new MonthlyTaskChannel("TaskName", "MyRequest", "14:30", 27, "UTC", watch);
    ...
    public void getTimeToFireNext__NowEndFebruaryLeapYear_TaskTimeDay15__15March() {
        ...
        MonthlyTaskChannel dailyTaskChannel = new MonthlyTaskChannel("TaskName", "MyRequest", "14:30", 15, "UTC", watch);
