 ...
 */
public class ScheduledTaskChannelDaily extends ScheduledTaskChannel {
     ...
     */
    public ScheduledTaskChannelDaily(String taskName, String request, String timeOfDay, String zoneId) {
     ...
     */
    ScheduledTaskChannelDaily(String taskName, String request, String timeOfDay, String zoneId, IWatch watch) {
